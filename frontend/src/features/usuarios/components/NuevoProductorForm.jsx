...
export function NuevoProductorForm({ onSubmit, isLoading, resultado }) {
  ...
  return (
    ...
    >
      <h3 className="font-bold">Nuevo productor</h3>
      ...
      {resultado && (
        <p className="text-sm text-aut-verde">
          Productor creado con usuario <code className="bg-gray-100 px-1 rounded">{resultado.usuario?.username}</code>.
